import { L as Logger, ay as SphericalPolynomial, b as Vector3, C as Constants, m as InternalTexture, B as BaseTexture, q as Tools, n as ILog2, f as PostProcess } from './index-DLpEu_NE.esm.js';
...
async function _UploadLevelsAsync(texture, imageData, canGenerateNonLODTextures, imageType = DefaultEnvironmentTextureImageType) {
    ...
    if (expandTexture) {
        if (engine.isWebGPU) {
            ...
            await import('./rgbdDecode.fragment-DGVE2GC1.esm.js');
        }
        else {
            await import('./rgbdDecode.fragment-CP-BZpYc.esm.js');
        }
...
//# sourceMappingURL=environmentTextureTools-BAUjK5K-.esm.js.map
