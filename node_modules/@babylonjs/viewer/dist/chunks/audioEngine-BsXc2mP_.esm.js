import { O as Observable, b as Vector3, Q as Quaternion, aC as PrecisionDate, p as Matrix, e as EngineStore, a4 as AbstractEngine } from './index-DLpEu_NE.esm.js';
...
class _WebAudioEngine extends AudioEngineV2 {
    ...
    async createBusAsync(name, options = {}) {
        const module = await import('./webAudioBus-DjJ6-v5c.esm.js');
    ...
    async createMainBusAsync(name, options = {}) {
        const module = await import('./webAudioMainBus-DKs6jU2H.esm.js');
    ...
    async createSoundAsync(name, source, options = {}) {
        const module = await import('./webAudioStaticSound-ClRtwfx7.esm.js');
    ...
    async createSoundSourceAsync(name, source, options = {}) {
        const module = await import('./webAudioSoundSource-B4Jn-zRw.esm.js');
    ...
    async createStreamingSoundAsync(name, source, options = {}) {
        const module = await import('./webAudioStreamingSound-BLzpkFV7.esm.js');
...
//# sourceMappingURL=audioEngine-BsXc2mP_.esm.js.map
