import { C as Constants, E as EffectWrapper, a as Camera, V as Vector2, R as RandomRange, T as Texture, b as Vector3, c as Engine, d as TmpVectors, e as EngineStore, L as Logger, P as PassPostProcess, f as PostProcess, S as SerializationHelper, _ as __decorate, s as serialize, g as RegisterClass } from './index-DLpEu_NE.esm.js';
...
import './postProcessRenderPipelineManagerSceneComponent-CbraCZSh.esm.js';
...
class ThinSSAO2PostProcess extends EffectWrapper {
    _gatherImports(useWebGPU, list) {
        if (useWebGPU) {
            ...
            list.push(import('./ssao2.fragment-Dn95HnzI.esm.js'));
        }
        else {
            list.push(import('./ssao2.fragment-B_KpKs0C.esm.js'));
        }
    }
    get textureWidth() {
...
class ThinSSAO2CombinePostProcess extends EffectWrapper {
    _gatherImports(useWebGPU, list) {
        if (useWebGPU) {
            this._webGPUReady = true;
            list.push(import('./ssaoCombine.fragment-DbPzctHC.esm.js'));
        }
        else {
            list.push(import('./ssaoCombine.fragment-BR4vHBZN.esm.js'));
        }
    }
...
//# sourceMappingURL=ssao2RenderingPipeline-Cd5qNh_Y.esm.js.map
