import { k as SceneComponentConstants, q as Tools, T as Texture, C as Constants, O as Observable, e as EngineStore, a0 as DrawWrapper, H as VertexBuffer, x as RenderTargetTexture, i as Material, _ as __decorate, s as serialize, g as RegisterClass, y as Vector4, L as Logger, c as Engine, f as PostProcess, a1 as _RetryWithInterval, b as Vector3, j as _WarnImport } from './index-DLpEu_NE.esm.js';
            ...
            this._drawWrapper.effect = engine.createEffect(shaders, [VertexBuffer.PositionKind], this._uniforms, this._samplers, defines, undefined, undefined, () => {
                ...
                if (this._options.extraInitializationsAsync) {
                    if (this.shaderLanguage === 1 /* ShaderLanguage.WGSL */) {
                        await Promise.all([import('./procedural.vertex-CrW7fdul.esm.js'), this._options.extraInitializationsAsync()]);
                    }
                    else {
                        await Promise.all([import('./procedural.vertex-B_nlUq4m.esm.js'), this._options.extraInitializationsAsync()]);
                    }
                }
                else {
                    if (this.shaderLanguage === 1 /* ShaderLanguage.WGSL */) {
                        await import('./procedural.vertex-CrW7fdul.esm.js');
                    }
                    else {
                        await import('./procedural.vertex-B_nlUq4m.esm.js');
                    }
                }
            });
        }
    ...
    _createTextures() {
        ...
        const cdfOptions = {
            ...
            extraInitializationsAsync: async () => {
                if (isWebGPU) {
                    await Promise.all([import('./iblCdfx.fragment-BOcBgjvS.esm.js'), import('./iblCdfy.fragment-dRmquOJ3.esm.js'), import('./iblScaledLuminance.fragment-BY_ZfwQG.esm.js')]);
                }
                else {
                    await Promise.all([import('./iblCdfx.fragment-C_8gMYrd.esm.js'), import('./iblCdfy.fragment-BG0kvKSA.esm.js'), import('./iblScaledLuminance.fragment-DKvPknQv.esm.js')]);
                }
            },
        };
        const icdfOptions = {
            ...
            extraInitializationsAsync: async () => {
                if (isWebGPU) {
                    await Promise.all([import('./iblIcdf.fragment-3xop-S2F.esm.js'), import('./iblDominantDirection.fragment-fQN1HYvu.esm.js')]);
                }
                else {
                    await Promise.all([import('./iblIcdf.fragment-CHvXUZjA.esm.js'), import('./iblDominantDirection.fragment-b0TdKyz6.esm.js')]);
                }
            },
        };
    ...
    _createDebugPass() {
        ...
        const debugOptions = {
            ...
            extraInitializations: (useWebGPU, list) => {
                if (useWebGPU) {
                    list.push(import('./iblCdfDebug.fragment-zX1qWTRG.esm.js'));
                }
                else {
                    list.push(import('./iblCdfDebug.fragment-BtUrCNmr.esm.js'));
                }
            },
        };
...
//# sourceMappingURL=iblCdfGenerator-CP8hkIWC.esm.js.map
