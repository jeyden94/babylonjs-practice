import { q as Tools, by as KeyboardEventTypes, b as Vector3, _ as __decorate, s as serialize, bz as CameraInputTypes, O as Observable, bA as PointerEventTypes, bB as EventConstants, p as Matrix, bC as CameraInputsManager, bD as TargetCamera, a4 as AbstractEngine, V as Vector2, aE as serializeAsVector3, g as RegisterClass, e as EngineStore, S as SerializationHelper, aD as GetClass, H as VertexBuffer, T as Texture, C as Constants, aW as SmartArray, L as Logger, bE as Decode, bF as GLTFFileLoaderMetadata, bG as GLTFMagicBase64Encoded, bH as DecodeBase64UrlToBinary, bI as RuntimeError, bJ as ErrorCodes, aB as RegisterSceneLoaderPlugin, bK as registerGLTFExtension, bL as unregisterGLTFExtension, i as Material, bM as registeredGLTFExtensions, w as Mesh, aj as AbstractMesh, bs as TransformNode, bN as deepMerge, bO as Geometry, Q as Quaternion, a as Camera, bP as Lazy, af as Buffer, aV as Color3, bQ as Deferred, bR as GetMimeType, bS as IsBase64DataUrl, bT as LoadFileError, bU as GetTypedArrayConstructor, d as TmpVectors, bV as BoundingInfo } from './index-DLpEu_NE.esm.js';
import { B as Bone } from './bone-T4AdXbPg.esm.js';
import { S as Skeleton } from './skeleton-DIesEWHc.esm.js';
import { A as AssetContainer } from './assetContainer-BuYx9oRV.esm.js';
import { G as GetMappingForKey } from './objectModelMapping-B8MY-rGq.esm.js';
...
const LazyAnimationGroupModulePromise = new Lazy(() => import('./animationGroup-agtQtNSj.esm.js'));
const LazyLoaderAnimationModulePromise = new Lazy(() => import('./glTFLoaderAnimation-Cp_T0j3W.esm.js'));
/**
            ...
            if (!this.parent.skipMaterials && this._pbrMaterialImpl == null) {
                if (this.parent.useOpenPBR || this.isExtensionUsed("KHR_materials_openpbr")) {
                    this._pbrMaterialImpl = {
                        materialClass: (await import('./openpbrMaterial-Kur5Yk1L.esm.js')).OpenPBRMaterial,
                        adapterClass: (await import('./openpbrMaterialLoadingAdapter-Br2hIutA.esm.js')).OpenPBRMaterialLoadingAdapter,
                    };
                }
                else {
                    this._pbrMaterialImpl = {
                        materialClass: (await import('./index-DLpEu_NE.esm.js').then(function (n) { return n.cz; })).PBRMaterial,
                        adapterClass: (await import('./pbrMaterialLoadingAdapter-W1eaHBAa.esm.js')).PBRMaterialLoadingAdapter,
                    };
                }
            }
...
//# sourceMappingURL=glTFLoader-Baj4UtGD.esm.js.map
