import { C as Constants, q as Tools, c6 as Clamp, L as Logger, c7 as EncodeArrayBufferToBase64, e as EngineStore, o as EffectRenderer, E as EffectWrapper, _ as __decorate, c8 as nativeOverride } from './index-DLpEu_NE.esm.js';
...
async function _CreateDumpResourcesAsync() {
    ...
    const { ThinEngine: thinEngineClass } = await import('./index-DLpEu_NE.esm.js').then(function (n) { return n.cy; });
    ...
    const { passPixelShader } = await import('./pass.fragment-nV3pTm7B.esm.js');
...
//# sourceMappingURL=dumpTools-CsOMiDc5.esm.js.map
