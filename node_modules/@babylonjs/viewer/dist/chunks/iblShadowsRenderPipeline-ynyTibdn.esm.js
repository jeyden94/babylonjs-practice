import { x as RenderTargetTexture, C as Constants, f as PostProcess, h as Color4, O as Observable, p as Matrix, y as Vector4, L as Logger, o as EffectRenderer, E as EffectWrapper, T as Texture, M as MultiRenderTarget, c as Engine, b as Vector3, z as MaterialPluginBase, A as PBRBaseMaterial, D as MaterialDefines, _ as __decorate, s as serialize, F as expandToProperty, g as RegisterClass, e as EngineStore, Q as Quaternion, q as Tools } from './index-DLpEu_NE.esm.js';
import { ShaderMaterial } from './shaderMaterial-DYnNt0Cp.esm.js';
import { P as ProceduralTexture } from './iblCdfGenerator-CP8hkIWC.esm.js';
import { G as GeometryBufferRenderer } from './geometryBufferRenderer-Bc3rZ_R7.esm.js';
import { P as PostProcessRenderPipeline, a as PostProcessRenderEffect } from './postProcessRenderEffect-CXOGhjZF.esm.js';
import { R as RawTexture } from './rawTexture-DgFI4awT.esm.js';
import { OpenPBRMaterial } from './openpbrMaterial-Kur5Yk1L.esm.js';
import { S as StandardMaterial } from './standardMaterial-E1p2MccU.esm.js';
import './geometryBufferRendererSceneComponent-B26p0WrJ.esm.js';
import './iblCdfGeneratorSceneComponent-DrWiWoiZ.esm.js';
import './bumpFragment-kqEylvm7.esm.js';
import './helperFunctions-BeKG9Vw5.esm.js';
import './sceneUboDeclaration-BE-dB_5K.esm.js';
import './bumpVertex-rXsvq30Z.esm.js';
...
class _IblShadowsVoxelRenderer {
        ...
        if (!this._voxelDebugPass) {
            const debugOptions = {
                ...
                extraInitializations: (useWebGPU, list) => {
                    if (useWebGPU) {
                        list.push(import('./iblVoxelGrid3dDebug.fragment-BWFTPXIK.esm.js'));
                    }
                    else {
                        list.push(import('./iblVoxelGrid3dDebug.fragment-CXrJBHA2.esm.js'));
                    }
                },
            };
    ...
    constructor(scene, iblShadowsRenderPipeline, resolutionExp = 6, triPlanarVoxelization = true) {
        ...
        this._copyMipEffectWrapper = new EffectWrapper({
            ...
            extraInitializationsAsync: async () => {
                if (isWebGPU) {
                    await import('./copyTexture3DLayerToTexture.fragment-Bs4NNQNo.esm.js');
                }
                else {
                    await import('./copyTexture3DLayerToTexture.fragment-mmlfhNup.esm.js');
                }
            },
        });
    ...
    _createTextures() {
        ...
        const voxelCombinedOptions = {
            ...
            extraInitializationsAsync: async () => {
                if (isWebGPU) {
                    await import('./iblCombineVoxelGrids.fragment-CDXsgnRr.esm.js');
                }
                else {
                    await import('./iblCombineVoxelGrids.fragment-DSHnB4Qy.esm.js');
                }
            },
        };
        if (this._engine.isWebGPU) {
        ...
        const generateVoxelMipOptions = {
            ...
            extraInitializationsAsync: async () => {
                if (isWebGPU) {
                    await import('./iblGenerateVoxelMip.fragment-BFJf44Ld.esm.js');
                }
                else {
                    await import('./iblGenerateVoxelMip.fragment-BlbAI-WB.esm.js');
                }
            },
        };
    ...
    _createVoxelMaterials() {
        ...
        this._voxelMaterial = new ShaderMaterial("voxelization", this._scene, "iblVoxelGrid", {
            ...
            extraInitializationsAsync: async () => {
                if (isWebGPU) {
                    await Promise.all([import('./iblVoxelGrid.fragment-D9uhM1nI.esm.js'), import('./iblVoxelGrid.vertex-DZEUBBTm.esm.js')]);
                }
                else {
                    await Promise.all([import('./iblVoxelGrid.fragment-CFJQYDDI.esm.js'), import('./iblVoxelGrid.vertex-C4TPtfer.esm.js')]);
                }
            },
        });
        ...
        this._voxelSlabDebugMaterial = new ShaderMaterial("voxelSlabDebug", this._scene, "iblVoxelSlabDebug", {
            ...
            extraInitializationsAsync: async () => {
                if (isWebGPU) {
                    await Promise.all([import('./iblVoxelSlabDebug.fragment-Cjte68r3.esm.js'), import('./iblVoxelSlabDebug.vertex-wt3q8B-Z.esm.js')]);
                }
                else {
                    await Promise.all([import('./iblVoxelSlabDebug.fragment-Cnj59w6g.esm.js'), import('./iblVoxelSlabDebug.vertex-Biyu3u3D.esm.js')]);
                }
            },
        });
    }
...
class _IblShadowsVoxelTracingPass {
    ...
    _createDebugPass() {
        ...
        if (!this._debugPassPP) {
            const debugOptions = {
                ...
                extraInitializations: (useWebGPU, list) => {
                    if (useWebGPU) {
                        list.push(import('./iblShadowDebug.fragment-B0aCvGP0.esm.js'));
                    }
                    else {
                        list.push(import('./iblShadowDebug.fragment-BdPOI4bP.esm.js'));
                    }
                },
            };
    ...
    _createTextures() {
        ...
        const textureOptions = {
            ...
            extraInitializationsAsync: async () => {
                if (isWebGPU) {
                    await Promise.all([import('./iblShadowVoxelTracing.fragment-Daap2S5M.esm.js')]);
                }
                else {
                    await Promise.all([import('./iblShadowVoxelTracing.fragment-C9lWlUkR.esm.js')]);
                }
            },
        };
...
class _IblShadowsSpatialBlurPass {
    ...
    _createTextures() {
        ...
        const textureOptions = {
            ...
            extraInitializationsAsync: async () => {
                if (isWebGPU) {
                    await Promise.all([import('./iblShadowSpatialBlur.fragment-CK8iNtor.esm.js')]);
                }
                else {
                    await Promise.all([import('./iblShadowSpatialBlur.fragment-CES70oum.esm.js')]);
                }
            },
        };
...
class _IblShadowsAccumulationPass {
    ...
    _createTextures() {
        ...
        const outputTextureOptions = {
            ...
            extraInitializationsAsync: async () => {
                if (isWebGPU) {
                    await Promise.all([import('./iblShadowAccumulation.fragment-B_E9nsXW.esm.js')]);
                }
                else {
                    await Promise.all([import('./iblShadowAccumulation.fragment-BZ0P3akT.esm.js')]);
                }
            },
        };
        ...
        const accumulationOptions = {
            ...
            extraInitializationsAsync: async () => {
                if (isWebGPU) {
                    await Promise.all([import('./pass.fragment-DzyWGVnd.esm.js')]);
                }
                else {
                    await Promise.all([import('./pass.fragment-nV3pTm7B.esm.js')]);
                }
            },
        };
...
class IblShadowsRenderPipeline extends PostProcessRenderPipeline {
    ...
    _getGBufferDebugPass() {
        ...
        const options = {
            ...
            extraInitializations: (useWebGPU, list) => {
                if (useWebGPU) {
                    list.push(import('./iblShadowGBufferDebug.fragment-XBKxCTga.esm.js'));
                }
                else {
                    list.push(import('./iblShadowGBufferDebug.fragment-gY9tZZyT.esm.js'));
                }
            },
        };
...
//# sourceMappingURL=iblShadowsRenderPipeline-ynyTibdn.esm.js.map
